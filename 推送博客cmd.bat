...
call git clone "https://gitee.com/darrichan/darrichan.github.io.git" deploy_git
...
call cd ..&& rd /s/q deploy_git
call hexo cl
call git add . &&git commit -m'1'&& git push --force --quiet "https://dc8dd9e1f2995e39b5ad59ac9897e515bca4cc47@github.com/darrichan/web7733.git" main:main